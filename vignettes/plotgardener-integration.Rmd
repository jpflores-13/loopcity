---
title: "Integrating loop communities with genomic data tracks"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Integrating loop communities with genomic data tracks}
...
## File paths
ctcf_bw <- K562_CTCF_bw()
h3k27ac_bw <- K562_H3K27ac_bw()
...
survey_region <- GenomicRanges::GRanges(
    ...
    ranges = IRanges::IRanges(
        start = survey_chromstart,
        end = survey_chromend
    )
)
a1_in <- GenomicRanges::countOverlaps(
    anchors(communities, "first"), survey_region
) > 0
a2_in <- GenomicRanges::countOverlaps(
    anchors(communities, "second"), survey_region
) > 0
