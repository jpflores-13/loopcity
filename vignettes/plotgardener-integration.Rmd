...
## Once loopcityData is available on Bioconductor, use instead:
# hic_file   <- loopcityData::K562_hic()
# loops_file <- loopcityData::K562_loops()
...
## Once loopcityData is available on Bioconductor, use instead:
# ctcf_bw    <- loopcityData::K562_CTCF_bw()
# h3k27ac_bw <- loopcityData::K562_H3K27ac_bw()
...
```{r figure, echo=FALSE, eval=TRUE, out.width="100%"}
